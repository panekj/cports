...
source = f"https://github.com/rust-lang/rust/archive/refs/heads/master.tar.gz"
...
@subpackage("rust-nightly-clippy")
def _(self):
...
@subpackage("rust-nightly-rustfmt")
def _(self):
